...
export const getWikipediaIdFromUrl = (url: string|undefined) => url ? url.split("/").pop()!.replace("%20", "_") : undefined;
export const getScopusIdFromUrl = (url: string|undefined) => url ?  url.split("/").pop()!.replace("%20", "_") : undefined;
